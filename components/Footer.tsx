      ...
      <div className="container-precision">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-16 mb-6 md:mb-20 text-center">
              ...
              {mainServices.map((s) => (
                <li key={s.id}>
                  <a
                    ...
                    target="_blank"
                    className="text-base hover:text-brand-primary transition-colors font-medium !text-slate-200 hover:!text-white opacity-100"
                  >
                    {s.title}
                  </a>
                </li>
          ...
          <div className="space-y-8 flex flex-col items-center">
            ...
            <ul className="space-y-4">
              <li><button onClick={() => onNavigate?.('sobre')} className="text-base hover:text-brand-primary transition-colors font-medium !text-slate-200 hover:!text-white opacity-100">Nossa história</button></li>
              <li><button onClick={() => onNavigate?.('servicos')} className="text-base hover:text-brand-primary transition-colors font-medium !text-slate-200 hover:!text-white opacity-100">Catálogo de serviços</button></li>
              <li><button onClick={() => onNavigate?.('contato')} className="text-base hover:text-brand-primary transition-colors font-medium !text-slate-200 hover:!text-white opacity-100">Fale com um técnico</button></li>
            </ul>
          </div>
            ...
            <div className="space-y-6 flex flex-col items-center">
              ...
              <div className="flex justify-center">
                <a
                  ...
                  className="h-14 flex items-center justify-center gap-3 px-10 bg-brand-primary hover:bg-brand-secondary text-white rounded-2xl font-bold text-sm btn-interact shadow-2xl shadow-brand-primary/20 hover:shadow-xl hover:shadow-brand-primary/30 hover:scale-[1.05] transition-all duration-300 whitespace-nowrap"
                >
