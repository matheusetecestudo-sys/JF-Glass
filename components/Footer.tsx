      ...
      <div className="container-precision">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-16 mb-6 md:mb-20 text-center">
          ...
          <div className="space-y-8 flex flex-col items-center">
            ...
            >
              <Logo variant="dark" className="h-16 md:h-20 w-auto" />
            </button>
            ...
            <div className="space-y-6 flex flex-col items-center">
              ...
              <div className="flex justify-center">
                <a
                  ...
                  className="h-14 flex items-center justify-center gap-3 px-10 bg-brand-accent hover:bg-brand-secondary text-white rounded-2xl font-bold text-sm btn-interact shadow-2xl shadow-brand-accent/20 hover:shadow-xl hover:shadow-brand-accent/30 hover:scale-[1.05] transition-all duration-300 whitespace-nowrap"
                >
